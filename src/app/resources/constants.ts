...
export const BOARD_COLOR = "#F5F5DC"
export const BACKGROUND_COLOR = "#e1c699"

// Train Card constants
export const NUMBER_OF_TOP_CARDS = 5
export const TRAIN_CARD_WIDTH = 84
export const TRAIN_CARD_HEIGHT = 55
export const TRAIN_CARD_Y_SPACING = 10

export const TRAIN_CARD_PILE_X = (SIDE_PANEL_WIDTH-TRAIN_CARD_WIDTH) / 2
export const TRAIN_CARD_PIE_Y = (BOARD_HEIGHT - TRAIN_CARD_Y_SPACING*10 - TRAIN_CARD_HEIGHT*7)/2
export const TRAIN_CARD_X = (SIDE_PANEL_WIDTH-TRAIN_CARD_WIDTH) / 2
export const TRAIN_CARD_Y = TRAIN_CARD_PIE_Y + TRAIN_CARD_HEIGHT + TRAIN_CARD_Y_SPACING*3
